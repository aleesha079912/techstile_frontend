...
void initState() {
  ...
  Widget _statusChip(int status) {
    ...
    switch (status) {
      case 2: bg = AppTheme.success.withOpacity(.15); fg = AppTheme.success; label = 'Mgr ✓'; break;
      case 3: bg = AppTheme.error.withOpacity(.15);   fg = AppTheme.error;   label = 'Mgr ✗'; break;
      case 4: bg = AppTheme.info.withOpacity(.15);    fg = AppTheme.info;    label = 'Approved'; break;
      case 5: bg = AppTheme.error.withOpacity(.15);   fg = AppTheme.error;   label = 'Rejected'; break;
      default: bg = AppTheme.surface.withOpacity(.15); fg = AppTheme.surface; label = 'Pending';
    }
    return Container(
