...
//                 Text(m.type, style: TextStyle(color: Colors.grey[600])),
//               ],
//             ),
//           ),
//           Row(
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const RegisterMachineScreen()),
          );
        },
        child: const Icon(Icons.add),
      ),
          ...
          child: Column(
            children: [
              const Align(
                ...
                child: Text(
                  "All Machines",
                  style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold,color: AppTheme.primary), // ✅ from theme
                ),
              ),
              const SizedBox(height: 8),
              const Align(
