        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _item(context, Icons.dashboard, "Home", () {
                  Get.off(() => const EmployeeDashboard());
                }),
                _item(context, Icons.qr_code_scanner, "Scan QR", () {
                  Get.off(() => const ScanqrCodeScreen());
                }),
                _item(context, Icons.person, "Profile", () {
                  Get.to(() => UserProfileScreen(userId: AuthService.userId!));
                }),
                ListTile(
                  leading: Badge(
                  ...
                  onTap: () async {
                    Get.back();
                    await Get.toNamed(AppRoutes.employeeNotifications);
                    getUnread();
                  },
                ),
                _item(context, Icons.payment, "History Screen", () {
